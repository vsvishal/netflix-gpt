  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute bg-black bg-opacity-80 w-full md:w-4/12 p-12 mx-auto my-36 left-0 right-0"
      >
        <h1 className="font-bold text-white text-2xl md:text-3xl mx-2 py-2">
